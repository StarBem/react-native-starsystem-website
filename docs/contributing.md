...
1. Check your version. A fix may have already been released in new
   a newer version. Update your version of react-native-starsystem to the
   latest.

2. Search the existing
   [issues](https://github.com/StarBem/react-native-starsystem/issues)
   and
   [pull requests](https://github.com/StarBem/react-native-starsystem/pulls).
...
[here](https://github.com/StarBem/react-native-starsystem/issues?utf8=✓&q=is%3Aissue+is%3Aopen+label%3A%22%3Aboom%3A++Bug%22+-label%3A%22✅+Fixed+-+Next+Release%22+-label%3A%22📥+PR+Submitted%22).

Improvements are separated into two categories:

- [New components](https://github.com/StarBem/react-native-starsystem/issues?utf8=✓&q=is%3Aissue+is%3Aopen+label%3A%22💡New+Component%22+-label%3A%22✅+Fixed+-+Next+Release%22+-label%3A%22📥+PR+Submitted%22+)
- [Enhancements](https://github.com/StarBem/react-native-starsystem/issues?utf8=✓&q=is%3Aissue+is%3Aopen+label%3A%22✨Enhancement%22+-label%3A%22✅+Fixed+-+Next+Release%22+-label%3A%22📥+PR+Submitted%22)
...
- Fork the **react-native-starsystem** repo
  [here](https://github.com/StarBem/react-native-starsystem)
